  ...
  return (
    <Box mx={{ base: "5vw", md: "10vw" }}>
      ...
      <Text>
        ...
        <br />- <em>Google Login:</em> Wenn Sie sich über Ihr Google-Konto
        anmelden, sammeln wir bestimmte Informationen von Ihrem Google-Profil
        gemäss den Berechtigungen, die Sie gewähren. Dazu gehören Ihr Name, Ihre
        E-Mail-Adresse und Profilbild.
      </Text>

      <Text mt="2">
        <strong>Andere Informationen</strong>
        <br />- <em>Hochgeladene Artikel:</em> Wenn Sie Artikel auf unserer
        Website hochladen, können wir Informationen über diese Artikel sammeln,
